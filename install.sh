...
echo "Quick start:"
echo "  Double-tap ALT  → speak → tap ALT again → text appears"
echo ""
echo "Useful commands:"
echo "  incant              — show daemon status"
echo "  incant status       — show detailed state"
echo "  incant ping         — health check"
echo "  incant stop         — stop the daemon"
echo "  incant doctor       — run diagnostics"
echo ""
echo "The daemon auto-starts on login via systemd."
echo ""
